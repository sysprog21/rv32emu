...
ifdef CURL
    ...
    # $(1): URL
    HTTP_GET = curl -fsSL $(1) 2>/dev/null
    # Download file with progress bar
    # $(1): URL, $(2): output file
    HTTP_DOWNLOAD = curl -fSL --progress-bar $(1) -o $(2)
    # Download file silently
    # $(1): URL, $(2): output file
    HTTP_DOWNLOAD_QUIET = curl -fsSL $(1) -o $(2)
else ifdef WGET
    HTTP_TOOL := wget
    HTTP_GET = wget -q -O- $(1) 2>/dev/null
    HTTP_DOWNLOAD = wget -q $(if $(WGET_HAS_PROGRESS),--show-progress) $(1) -O $(2)
    HTTP_DOWNLOAD_QUIET = wget -q $(1) -O $(2)
else
    HTTP_TOOL :=
endif
