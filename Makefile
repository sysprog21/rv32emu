...
# Verify GNU make version (3.81+ required)
ifeq ($(filter 3.81 3.82 3.83 3.84 4.% 5.%,$(MAKE_VERSION)),)
$(error GNU make 3.81 or higher is required. Current version: $(MAKE_VERSION))
endif
